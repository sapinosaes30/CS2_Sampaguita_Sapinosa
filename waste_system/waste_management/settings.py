...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-&8(z#2ttk_=+cu89ids#bf29f(0=d*m-x&gq^0mz9f3-tvky2r')
...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'rest_framework',
    'whitenoise.runserver_nostatic',  # Use whitenoise in development too
    # Custom apps
    'users',
    'core',
    'dashboard',
